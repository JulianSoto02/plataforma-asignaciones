      ...
      <div className="px-4 sm:px-6 lg:px-8 py-3">
        <div className="flex items-center justify-between">
          ...
          <div className="md:hidden flex items-center">
            <span className="text-xl font-semibold">Asignaciones Académicas</span>
          </div>

          {/* Navegación de encabezado */}
          <nav className="hidden md:flex space-x-8">
            <Link to="/docente" className="text-gray-700 hover:text-gray-900 px-3 py-2 text-sm font-medium">
              Inicio
            </Link>
            <Link to="/docente/preferencias" className="text-gray-700 hover:text-gray-900 px-3 py-2 text-sm font-medium">
              Preferencias
            </Link>
            <Link to="/docente/horarios" className="text-gray-700 hover:text-gray-900 px-3 py-2 text-sm font-medium">
              Horarios
            </Link>
          </nav>
